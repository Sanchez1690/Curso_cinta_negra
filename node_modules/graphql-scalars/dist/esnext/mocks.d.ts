export declare const BigInt: () => number;
...
export { URLMock as URL, NonNegativeInt as UnsignedInt, NonNegativeFloat as UnsignedFloat, BigInt as Long, };
